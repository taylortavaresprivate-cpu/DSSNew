...
M.cfg = {
	...
	nls_cut_amount     = 0.0,
	nls_only_upshift   = true,
	nls_min_rpm        = 3000,
	blip_enabled       = false,
	blip_intensity     = 0.6,
	blip_duration      = 150,
	blip_only_braking  = true,
	abs_enabled         = true,
	abs_level           = 15,
	abs_threshold       = 0.032,
	abs_min_brake       = 0.14,
...
M.SAVE_KEYS = {
	...
	'nls_enabled','nls_cut_duration','nls_cut_amount','nls_only_upshift','nls_min_rpm',
	'blip_enabled','blip_intensity','blip_duration','blip_only_braking',
